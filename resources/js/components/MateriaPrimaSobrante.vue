...
<script>
    export default {
        ...
        methods : {
            listarSobrantesOrden(page,identificador){
                let me=this;
                var url='/ordenpedidocliente/listarsobrantes?page=' + page + '&identificador=' + identificador;
            ...
            cambiarPagina(page){
                ...
                this.listarSobrantesOrden(page,this.identificador);
            }
        },
        mounted() {
            this.listarSobrantesOrden(1,this.identificador);
        }
    }
</script>
<style>
